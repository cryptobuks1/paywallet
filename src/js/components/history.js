function BalanceHistoryViewModel() {
  ...
  self.availableAssets = !USE_TESTNET ? ko.observableArray(["XPT", "LTC"]) : ko.observableArray(["XPT"]);
  ...
  self.init = function() {
    ...
    failoverAPI("get_owned_assets", { addresses: WALLET.getAddressesList() }, function(data, endpoint) {
      ...
      //^ this way, XPT and LTC stay at the top, but the other assets are alphabetically sorted
    });
